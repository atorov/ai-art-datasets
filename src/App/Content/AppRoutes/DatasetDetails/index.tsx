...
const DatasetDetails = () => {
    ...
    if (datasetIndex < 0) {
        return <Navigate to={{ pathname: '/datasets' }} />
    }
        ...
        <Container sx={{ mt: 4 }}>
            ...
            >
                <Button
                    ...
                    variant="contained"
                    color="secondary"
                    onClick={() => navigate(`/datasets/${datasetId}/download`)}
                >
                    Download
                </Button>
            </Box>
            ...
            >
                <Button
                    ...
                    onClick={() => navigate(`/datasets/${prevDatasetId}`)}
                >
                    <NavigateBeforeIcon />
                    &nbsp;Prev
                </Button>
                ...
                <Button
                    disabled={!items.length}
                    onClick={() => navigate(`/datasets/${nextDatasetId}`)}
                >
                    Next&nbsp;
                    <NavigateNextIcon />
                </Button>
